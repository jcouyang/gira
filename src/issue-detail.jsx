						...
						<div className="discussion-topic">
							...
							<div className="discussion-topic-header">
								<dl className="form">
									...
									<dd>
										<div className="fieldWithErrors"><input type="text" value="" autofocus="autofocus" className="required title js-auto-save" id="issue_title" name="issue[title]" placeholder="Title" required="required" size="30" tabindex="1"/></div>
									</dd>
								</dl>
							</div>
							...
							<div className="comment-content">
                              ...
                              Flavored Markdown</a></span>
											...
											<div className="comment-form-error js-comment-form-error" style="display:none"> There was an error creating
												your Issue:
											</div>
											<div id="write_bucket_" className="write-content upload-enabled is-default" data-model="assets">
												...
												<textarea name="issue[body]" tabindex="1" id="issue_body" placeholder="Leave a comment" className="comment-form-textarea js-comment-field js-size-to-fit js-quote-selection-target  input-with-fullscreen-icon" data-suggester="_new_preview_suggester"></textarea>
